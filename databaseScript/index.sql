...
CREATE TABLE `weekly`  (
  ...
  `product_time` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
  `date_range` json,
  `simulation_range` json,
  ...
  `description` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '',
