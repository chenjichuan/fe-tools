...
<p align="center">
  <a href="http://47.99.215.225/login" target="_blank">
...
首先需要了解什么是 SSR 以及 SSR 是怎么工作的，对于开发 SSR 项目有很大的帮助。[Vue SSR](https://cn.vuejs.org/v2/guide/ssr.html) 官方的文档教你一步一步了解SSR基础知识，对于这之后碰到的问题很有帮助。
nuxt 在这基础之上做了封装，提供很强大的功能。需要优先了解。
...
https 需要绑定域名（域名需要买还有备案blablabla）. 还需要部署ssh证书才可以使用。因为懒得买域名所以没部署https
nuxt官方有https相关配置。
